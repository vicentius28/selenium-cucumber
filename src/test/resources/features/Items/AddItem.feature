Feature: Registrar un ítem
  ...
  Scenario: Registrar un nuevo ítem
    ...
    And el usuario abre el formulario de nuevo ítem
    When el usuario ingresa nombre "producto_test1", categoría "Prueba", costo "10000", precio "24990", stock "15", recibidos "5" y nivel de reorden "1" y presiona submit
    And el usuario abre el formulario de nuevo ítem
    When el usuario ingresa nombre "producto_test2", categoría "Prueba", costo "15000", precio "29990", stock "20", recibidos "10" y nivel de reorden "1" y presiona submit
